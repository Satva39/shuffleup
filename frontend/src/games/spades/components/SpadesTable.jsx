...
export default function SpadesTable({
  ...
  const isViewerTurn =
    state.phase === "trick-play" && state.turnActorId === user.id;
      ...
      <div className="spades-shell">
        ...
        <section className="spades-table-wrap">
          ...
          <div className="spades-table">
            <div
              className="table-ornament table-ornament-left"
              aria-hidden="true"
            />
            <div
              className="table-ornament table-ornament-right"
              aria-hidden="true"
            />
            ...
            <div className="table-center">
              ...
              <TrickArea
                ...
                winnerSeat={
                  state.handResult?.winnerSeat || state.lastTrickWinner
                }
                players={state.players}
        ...
        <section className="spades-below-table">
          ...
          {state.phase === "hand-complete" &&
            !state.winnerTeam &&
            viewer?.seat === state.dealer && (
              <button
                className="primary-button next-hand"
                type="button"
                onClick={nextHand}
              >
                Start Next Hand
